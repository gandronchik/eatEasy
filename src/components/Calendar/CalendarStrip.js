          ...
          <View style={[
            ...
            {marked &&
              <View style={[
                ...
                {backgroundColor: highlight ? 'white' : '#FF8C00'}
              ]} />
            }
          </View>
        </TouchableOpacity>
...
class CalendarStrip extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isTodayVisible: true,
      pageOfToday: 1, // page of today in calendar, start from 0
      currentPage: 1, // current page in calendar,  start from 0
    };
  }
  ...
  getInitialDates(weekStartsOn=0) {
    ...
    const last2WeekOfToday = subDays(TODAY, 7);
    const next2WeekOfToday = addDays(TODAY, 7);
  ...
  render() {
    ...
    return (
      <View style={styles.container} {...this._panResponder.panHandlers}>
        <Weeks isChinese={false} weekStartsOn={weekStartsOn} />
        <FlatList
